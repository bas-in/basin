...
| `CREATE TABLE t (id INT, EXCLUDE USING gist (id WITH =))` | 🚫 | 🚫 | 🚫 | feature not supported: EXCLUDE constraint is not supported (SQLSTATE 0A000): … |
...
| `CREATE TABLE __t (c REAL); DROP TABLE __t` | 🚫 | 🚫 | 🚫 | internal: unsupported in PoC: DROP TABLE __t |
...
| `CREATE TABLE __t (c CITEXT); DROP TABLE __t` | 🚫 | 🚫 | 🚫 | internal: unsupported in PoC: DROP TABLE __t |
...
| `CREATE TABLE __t (c TIME); DROP TABLE __t` | 🚫 | 🚫 | 🚫 | internal: unsupported in PoC: DROP TABLE __t |
...
| `CREATE TABLE __t (c INTERVAL); DROP TABLE __t` | 🚫 | 🚫 | 🚫 | internal: unsupported in PoC: DROP TABLE __t |
