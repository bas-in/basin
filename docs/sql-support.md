...
If you tried PG syntax that's not in this matrix, [open an issue](https://github.com/vul-os/basin/issues/new?template=sql_compatibility.yml&title=Missing+SQL+syntax%3A+) — we triage compatibility gaps within 48 hours.
