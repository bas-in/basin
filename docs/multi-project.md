...
sidebar_position: 20
summary: "Project-membership model and isolation primitives for thousands of projects on one cluster."
---
...
Real-cloud (S3-compatible store / Tigris) numbers: [`benchmark/index_real.html`](../benchmark/index_real.html).
...
- Storage: 100 MB compressed to ~80 MB Parquet on Tigris (S3-compatible) = $0.0016/mo
