...
# DEPRECATION NOTICE
# ──────────────────
# This benchmark has been superseded by benchmark/three_way/run_three_way.sh
# which compares Basin Cloud vs Neon vs Supabase in a single region.
# The old single-target Postgres comparison is preserved here for historical
# local runs only.  Do not use this as the canonical cloud-comparison harness.
# See benchmark/README.md for the current recommended flow.
#
