...
const TYPE_FACTS: &[TypeFact] = &[
    // ─── Scalar builtins (24) ───────────────────────────────────────────────
    TypeFact { label: "BOOL", oid: oid::BOOL, typname: "bool", typlen: 1, typtype: 'b', typcategory: 'B', typarray: 1000 },
    TypeFact { label: "BYTEA", oid: oid::BYTEA, typname: "bytea", typlen: -1, typtype: 'b', typcategory: 'U', typarray: 1001 },
    TypeFact { label: "CHAR", oid: oid::CHAR, typname: "char", typlen: 1, typtype: 'b', typcategory: 'Z', typarray: 1002 },
    TypeFact { label: "NAME", oid: oid::NAME, typname: "name", typlen: 64, typtype: 'b', typcategory: 'S', typarray: 1003 },
    TypeFact { label: "INT8", oid: oid::INT8, typname: "int8", typlen: 8, typtype: 'b', typcategory: 'N', typarray: 1016 },
    TypeFact { label: "INT2", oid: oid::INT2, typname: "int2", typlen: 2, typtype: 'b', typcategory: 'N', typarray: 1005 },
    TypeFact { label: "INT4", oid: oid::INT4, typname: "int4", typlen: 4, typtype: 'b', typcategory: 'N', typarray: 1007 },
    TypeFact { label: "TEXT", oid: oid::TEXT, typname: "text", typlen: -1, typtype: 'b', typcategory: 'S', typarray: 1009 },
    TypeFact { label: "OID", oid: oid::OID, typname: "oid", typlen: 4, typtype: 'b', typcategory: 'N', typarray: 1028 },
    TypeFact { label: "JSON", oid: oid::JSON, typname: "json", typlen: -1, typtype: 'b', typcategory: 'U', typarray: 199 },
    TypeFact { label: "XML", oid: oid::XML, typname: "xml", typlen: -1, typtype: 'b', typcategory: 'U', typarray: 143 },
    TypeFact { label: "FLOAT4", oid: oid::FLOAT4, typname: "float4", typlen: 4, typtype: 'b', typcategory: 'N', typarray: 1021 },
    TypeFact { label: "FLOAT8", oid: oid::FLOAT8, typname: "float8", typlen: 8, typtype: 'b', typcategory: 'N', typarray: 1022 },
    TypeFact { label: "BPCHAR", oid: oid::BPCHAR, typname: "bpchar", typlen: -1, typtype: 'b', typcategory: 'S', typarray: 1014 },
    TypeFact { label: "VARCHAR", oid: oid::VARCHAR, typname: "varchar", typlen: -1, typtype: 'b', typcategory: 'S', typarray: 1015 },
    TypeFact { label: "DATE", oid: oid::DATE, typname: "date", typlen: 4, typtype: 'b', typcategory: 'D', typarray: 1182 },
    TypeFact { label: "TIME", oid: oid::TIME, typname: "time", typlen: 8, typtype: 'b', typcategory: 'D', typarray: 1183 },
    TypeFact { label: "TIMESTAMP", oid: oid::TIMESTAMP, typname: "timestamp", typlen: 8, typtype: 'b', typcategory: 'D', typarray: 1115 },
    TypeFact { label: "TIMESTAMPTZ", oid: oid::TIMESTAMPTZ, typname: "timestamptz", typlen: 8, typtype: 'b', typcategory: 'D', typarray: 1185 },
    TypeFact { label: "INTERVAL", oid: oid::INTERVAL, typname: "interval", typlen: 16, typtype: 'b', typcategory: 'T', typarray: 1187 },
    TypeFact { label: "TIMETZ", oid: oid::TIMETZ, typname: "timetz", typlen: 12, typtype: 'b', typcategory: 'D', typarray: 1270 },
    TypeFact { label: "NUMERIC", oid: oid::NUMERIC, typname: "numeric", typlen: -1, typtype: 'b', typcategory: 'N', typarray: 1231 },
    TypeFact { label: "UUID", oid: oid::UUID, typname: "uuid", typlen: 16, typtype: 'b', typcategory: 'U', typarray: 2951 },
    TypeFact { label: "JSONB", oid: oid::JSONB, typname: "jsonb", typlen: -1, typtype: 'b', typcategory: 'U', typarray: 3807 },
    // ─── Pseudo-types (3) ───────────────────────────────────────────────────
    TypeFact { label: "UNKNOWN", oid: oid::UNKNOWN, typname: "unknown", typlen: -2, typtype: 'p', typcategory: 'X', typarray: 0 },
    TypeFact { label: "VOID", oid: oid::VOID, typname: "void", typlen: 4, typtype: 'p', typcategory: 'P', typarray: 0 },
    TypeFact { label: "RECORD", oid: oid::RECORD, typname: "record", typlen: -1, typtype: 'p', typcategory: 'P', typarray: 2287 },
    // ─── Catalog-internal builtins (4) ──────────────────────────────────────
    TypeFact { label: "OIDVECTOR", oid: oid::OIDVECTOR, typname: "oidvector", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 1013 },
    TypeFact { label: "INT2VECTOR", oid: oid::INT2VECTOR, typname: "int2vector", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 1006 },
    TypeFact { label: "PG_NODE_TREE", oid: oid::PG_NODE_TREE, typname: "pg_node_tree", typlen: -1, typtype: 'b', typcategory: 'Z', typarray: 0 },
    TypeFact { label: "ANYARRAY", oid: oid::ANYARRAY, typname: "anyarray", typlen: -1, typtype: 'p', typcategory: 'P', typarray: 0 },
    // ─── Range builtins (6) ─────────────────────────────────────────────────
    TypeFact { label: "INT4RANGE", oid: oid::INT4RANGE, typname: "int4range", typlen: -1, typtype: 'r', typcategory: 'R', typarray: 3905 },
    TypeFact { label: "NUMRANGE", oid: oid::NUMRANGE, typname: "numrange", typlen: -1, typtype: 'r', typcategory: 'R', typarray: 3907 },
    TypeFact { label: "TSRANGE", oid: oid::TSRANGE, typname: "tsrange", typlen: -1, typtype: 'r', typcategory: 'R', typarray: 3909 },
    TypeFact { label: "TSTZRANGE", oid: oid::TSTZRANGE, typname: "tstzrange", typlen: -1, typtype: 'r', typcategory: 'R', typarray: 3911 },
    TypeFact { label: "DATERANGE", oid: oid::DATERANGE, typname: "daterange", typlen: -1, typtype: 'r', typcategory: 'R', typarray: 3913 },
    TypeFact { label: "INT8RANGE", oid: oid::INT8RANGE, typname: "int8range", typlen: -1, typtype: 'r', typcategory: 'R', typarray: 3927 },
    ...
    // Rust identifier.
    TypeFact { label: "BOOL_ARRAY", oid: oid::BOOL_ARRAY, typname: "_bool", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "BYTEA_ARRAY", oid: oid::BYTEA_ARRAY, typname: "_bytea", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "CHAR_ARRAY", oid: oid::CHAR_ARRAY, typname: "_char", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "NAME_ARRAY", oid: oid::NAME_ARRAY, typname: "_name", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "INT2_ARRAY", oid: oid::INT2_ARRAY, typname: "_int2", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "INT4_ARRAY", oid: oid::INT4_ARRAY, typname: "_int4", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "TEXT_ARRAY", oid: oid::TEXT_ARRAY, typname: "_text", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "BPCHAR_ARRAY", oid: oid::BPCHAR_ARRAY, typname: "_bpchar", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "VARCHAR_ARRAY", oid: oid::VARCHAR_ARRAY, typname: "_varchar", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "INT8_ARRAY", oid: oid::INT8_ARRAY, typname: "_int8", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "FLOAT4_ARRAY", oid: oid::FLOAT4_ARRAY, typname: "_float4", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "FLOAT8_ARRAY", oid: oid::FLOAT8_ARRAY, typname: "_float8", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "OID_ARRAY", oid: oid::OID_ARRAY, typname: "_oid", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "DATE_ARRAY", oid: oid::DATE_ARRAY, typname: "_date", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "TIME_ARRAY", oid: oid::TIME_ARRAY, typname: "_time", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "TIMESTAMP_ARRAY", oid: oid::TIMESTAMP_ARRAY, typname: "_timestamp", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "TIMESTAMPTZ_ARRAY", oid: oid::TIMESTAMPTZ_ARRAY, typname: "_timestamptz", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "INTERVAL_ARRAY", oid: oid::INTERVAL_ARRAY, typname: "_interval", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "NUMERIC_ARRAY", oid: oid::NUMERIC_ARRAY, typname: "_numeric", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "JSON_ARRAY", oid: oid::JSON_ARRAY, typname: "_json", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "JSONB_ARRAY", oid: oid::JSONB_ARRAY, typname: "_jsonb", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "UUID_ARRAY", oid: oid::UUID_ARRAY, typname: "_uuid", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    // ─── Vector array builtins (2) ──────────────────────────────────────────
    TypeFact { label: "OIDVECTOR_ARRAY", oid: oid::OIDVECTOR_ARRAY, typname: "_oidvector", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "INT2VECTOR_ARRAY", oid: oid::INT2VECTOR_ARRAY, typname: "_int2vector", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    // ─── Range array builtins (6) ────────────────────────────────────────────
    TypeFact { label: "INT4RANGE_ARRAY", oid: oid::INT4RANGE_ARRAY, typname: "_int4range", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "NUMRANGE_ARRAY", oid: oid::NUMRANGE_ARRAY, typname: "_numrange", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "TSRANGE_ARRAY", oid: oid::TSRANGE_ARRAY, typname: "_tsrange", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "TSTZRANGE_ARRAY", oid: oid::TSTZRANGE_ARRAY, typname: "_tstzrange", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "DATERANGE_ARRAY", oid: oid::DATERANGE_ARRAY, typname: "_daterange", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
    TypeFact { label: "INT8RANGE_ARRAY", oid: oid::INT8RANGE_ARRAY, typname: "_int8range", typlen: -1, typtype: 'b', typcategory: 'A', typarray: 0 },
];
