...
| `citext` | native `citext` type | 🛠 | Phase 5.30. Type, comparison operators, UNIQUE folding, and WHERE-clause / ORDER BY auto-folding (`CitextAnalyzerRule`) shipped (see Types table). No `CREATE EXTENSION citext;` needed — always available. Remaining: un-ignore the end-to-end harness. |
